               ...
               <div className='dark:text-white '>
                  ...
                  <div className='mt-8'>
                     ...
                     <div className='mt-4 flex justify-between'>
                        <div className='py-1 w-full mx-1 text-sm dark:bg-dark-blue shadow-xl  flex justify-center items-center'>France</div>
                        <div className='py-1 w-full mx-1 text-sm dark:bg-dark-blue shadow-xl  flex justify-center items-center'>Germany</div>
                        <div className='py-1 w-full mx-1 text-sm dark:bg-dark-blue shadow-xl  flex justify-center items-center'>Nethelands</div>
